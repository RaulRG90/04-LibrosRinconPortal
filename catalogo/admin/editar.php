...
if (file_exists("../portadas_ce/".$item_edit.".jpg")) { ?>
  ...
  <div class="btn">
    <span>Portada</span>
    <input type="file" name="img_portada" id="img_portada" disabled>
  </div>
...
if (file_exists("../portadas_ce/".$item_edit."_int1.jpg")) { ?>
  ...
  <div class="btn">
    ...
    <input type="file" name="img_int1" id="img_int1" disabled>
  </div>
  <div class="file-path-wrapper">
...
if (file_exists("../portadas_ce/".$item_edit."_int2.jpg")) { ?>
  ...
  <div class="btn">
    ...
    <input type="file" name="img_int2" id="img_int2" disabled>
  </div>
  <div class="file-path-wrapper">

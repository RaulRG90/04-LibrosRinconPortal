...
function redimg ($rutaImagenOriginal, $max_ancho, $max_alto, $calidad, $saveas){
	...
	*/
	...
	// $saveas ---> "./imagen/retoque.jpg"
	$guardar = imagejpeg($tmp,$saveas,$calidad);
	...
	if($guardar){return true;}else{return false;}
}
